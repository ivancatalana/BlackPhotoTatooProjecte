                                ...
                                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                                    ...
                                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                        ...
                                        for (QueryDocumentSnapshot messageDocument : queryDocumentSnapshots) {
                                            ...
                                            // Verificar si el UID del remitente o receptor coincide con el UID del usuario actual
                                            fetchUserData(userId, new FetchUserDataCallback() {
                                                @Override
...
//        } else {
    ...
    private void fetchUserData(String uid, FetchUserDataCallback callback) {
    ...
    public static interface FetchUserDataCallback {
